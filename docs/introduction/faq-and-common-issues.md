...
is a service configuration file that is used in TEST environment as sometimes the configuration differs from the standard one
defined in [`services.yml`](../../project-base/src/Shopsys/ShopBundle/Resources/config/services.yml).
